...
```html
<span style="font-family: 'Arial'; color: red; background-color: yellow;">The website also includes a reservation system that allows students to view the availability of teachers on different days of the week and book appointments accordingly.</span>
```
